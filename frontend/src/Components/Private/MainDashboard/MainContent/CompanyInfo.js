  ...
  return (
    <div className="row  bg-white p-2 m-1 border rounded" >
      <div className="col-12 col-lg-8 py-1 " >
        ...
        <span className="text-dark  py-4 heading_fontsize_first">Total Projects <span className="count_fontsize" style={{ color: '#4FB4FE' }}> | </span> <span className="count_fontsize">3001</span></span>
            ...
            <div className="p-4 background_style PurpleColor" >
              <div className="row">
                <div className="col-9">
                  ...
                  <h2 className="pt-2 fw-bold card_count">112</h2>
                </div>
